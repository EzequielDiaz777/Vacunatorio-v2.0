...
router.get("/", controllers.centroDeVacunacionController.getAllCentrosDeVacunacion);
router.get("/crear", controllers.centroDeVacunacionController.crearCentroDeVacunacion);
router.post("/", controllers.centroDeVacunacionController.createCentroDeVacunacion);
router.get("/:id", controllers.centroDeVacunacionController.editCentroDeVacunacion);
